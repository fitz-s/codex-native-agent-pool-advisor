...
const ACTIVE_EVENTS = ["SessionStart", "UserPromptSubmit", "PreToolUse", "PostCompact"];
...
async function main() {
  ...
  process.stdout.write(`${JSON.stringify({ installed: targetHook, active_events: ACTIVE_EVENTS, retired_legacy_watcher: watcher }, null, 2)}\n`);
}
